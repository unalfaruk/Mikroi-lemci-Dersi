...
int buttonPushCounter = 15;   // Sayaç
...
void loop() {
  ...
  if (buttonState != lastButtonState) {
    ...
    // Eğer butondan gelen değer yoksa, yani butona basılmamış
    // Butondan elimizi çekiyoruz durumu
    // Buton açık duruma geçiyor
    // Veya başka ihtimaller varsa onlar     
    } else {
